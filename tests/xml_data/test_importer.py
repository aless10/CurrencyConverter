...
from convert_app.xml_data.importer import get_data_from_url, get_xml_from_string, get_dict_from_xml_element
...
def test_get_dict_from_xml_element():
    e = etree.fromstring('<Cube>'
                         ...
                         '  </Cube>'
                         '</Cube>')
    d = get_dict_from_xml_element(e)
    assert d == {"2019-10-22": [{"currency": "USD", "rate": "1.113"},
                                {"currency": "JPY", "rate": "120.87"}],
                 "2019-10-23": [{"currency": "BGN", "rate": "1.9558"},
